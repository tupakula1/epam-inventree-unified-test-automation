"""Locators for https://docs.inventree.org/en/stable/part/views/."""


class DocsPartViewsLocators:
    URL = "https://docs.inventree.org/en/stable/part/views/"
    ...
    SECTION_IDS = (
        ...
        "used-in",
        "suppliers",
        "Part_Suppliers_and_Manufacturers",
        "purchase-orders",
        "sales-orders",
        "stock-history",
        "test-templates",
        "related-parts",
        "Related_Parts_Example_View",
        "parameters",
        "attachments",
        "notes",
    )
